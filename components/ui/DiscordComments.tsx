  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-8">
      ...
      <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-8 text-center">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Connect with the community, ask questions, and share your learning journey about <strong>{topic}</strong>
          </p>
          <a
          ...
          <p className="text-sm text-gray-500 mt-4">
            Free to join • Active community • Expert help available
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 text-sm text-gray-600 text-center">
        <p>
          💡 <strong>Tip:</strong> You'll need a Discord account to participate in discussions
        </p>
      </div>
    </div>
  );
