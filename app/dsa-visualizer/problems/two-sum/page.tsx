    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white pt-16 md:pt-20">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
          {/* Breadcrumb */}
          <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 mb-4 md:mb-6 overflow-x-auto">
            <Link href="/" className="hover:text-indigo-600 transition-colors whitespace-nowrap">Home</Link>
            <svg className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            <Link href="/dsa-visualizer" className="hover:text-indigo-600 transition-colors whitespace-nowrap">DSA Visualizer</Link>
            <svg className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
            <span className="text-gray-900 font-medium whitespace-nowrap">Two Sum</span>
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 md:gap-6">
            <div className="flex-grow animate-fade-in">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-3 md:mb-4">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900">Two Sum</h1>
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-100 text-green-700 rounded-full text-xs sm:text-sm font-medium w-fit">
            ...
            {/* Quick Stats */}
            <div className="flex gap-2 sm:gap-3 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              <div className="px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 rounded-xl border border-gray-200 text-center flex-1 sm:flex-none hover:border-indigo-200 transition-all">
                <div className="text-xs text-gray-600 mb-1">Time</div>
                <div className="text-base sm:text-lg font-bold text-gray-900">O(n)</div>
              </div>
              <div className="px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 rounded-xl border border-gray-200 text-center flex-1 sm:flex-none hover:border-indigo-200 transition-all">
                <div className="text-xs text-gray-600 mb-1">Space</div>
                <div className="text-base sm:text-lg font-bold text-gray-900">O(n)</div>
              </div>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="lg:hidden">
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 bg-white border border-gray-200 rounded-xl hover:border-indigo-200 transition-all"
            >
              ...
              <svg className={`w-5 h-5 transition-transform ${tocOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            
            {tocOpen && (
              <div className="mt-4 bg-white p-4 rounded-xl border border-gray-200 shadow-sm animate-fade-in">
                <nav className="space-y-2">
                  {[
                    ...
                    <a
                      ...
                      className="block text-sm text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 px-3 py-2 rounded-lg transition-all"
                    >
                      {item.label}
                    </a>
                  ))}
          ...
          <aside className="hidden lg:block lg:col-span-3">
            <div className="sticky top-24 animate-fade-in">
              ...
              <Link
                href="/dsa-visualizer"
                className="mt-4 flex items-center gap-2 text-sm text-gray-600 hover:text-indigo-600 px-3 py-2 rounded-lg hover:bg-gray-50 transition-all"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <main className="lg:col-span-9 space-y-6 md:space-y-8">
            {/* Problem Section */}
            <section id="problem" className="scroll-mt-24 animate-fade-in">
              <div className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-6">
                  Given an array of integers <code className="px-2 py-1 bg-gray-100 rounded text-sm font-mono">nums</code> and an integer <code className="px-2 py-1 bg-gray-100 rounded text-sm font-mono">target</code>, return indices of the two numbers such that they add up to <code className="px-2 py-1 bg-gray-100 rounded text-sm font-mono">target</code>.
                </p>

                <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 md:p-6 overflow-x-auto">
                  <div className="text-sm font-semibold text-gray-700 mb-3">Example:</div>
                  <pre className="text-xs sm:text-sm font-mono text-gray-800 leading-relaxed">{`Input: nums = [2, 7, 11, 15], target = 9
Output: [0, 1]
